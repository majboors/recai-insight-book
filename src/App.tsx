    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/transactions/:id" element={<ProtectedRoute><AppLayout><Transactions /></AppLayout></ProtectedRoute>} />
          <Route path="/templates" element={<ProtectedRoute><AppLayout><ReceiptTemplates /></AppLayout></ProtectedRoute>} />
